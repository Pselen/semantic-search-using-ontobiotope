...
def extract_habitat_mentions():
    ...
    return habitat_mentions
#%%
def compute_mention_embedding(mentions):
    ...
    print(f'Could not find {cant_find}')
    return mention_to_embedding
#%%
# Read a1 files
...
habitat_mentions = extract_habitat_mentions()
mention_to_embedding = compute_mention_embedding(habitat_mentions)
#%%
